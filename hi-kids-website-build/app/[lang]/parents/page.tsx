          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 items-center">
            ...
            <div className="lg:col-span-7 space-y-10 text-center lg:text-left order-2 lg:order-1 lg:translate-x-12 xl:translate-x-20">
              <MotionWrapper direction="right">
                <div className="space-y-8">
                  <h1 className="text-6xl lg:text-8xl xl:text-[9rem] font-fredoka font-bold text-slate-900 leading-[0.9] tracking-tight text-balance">
            ...
            <div className="lg:col-span-5 flex justify-center lg:justify-end order-1 lg:order-2">
              <div className="lg:translate-x-32 xl:translate-x-56 w-full flex justify-center lg:justify-end">
                <MotionWrapper type="fade" className="relative w-full max-w-[20rem] sm:max-w-sm md:md:max-w-md lg:max-w-[32rem] xl:max-w-[40rem] aspect-square z-10">
                  <Image
      ...
      <section className="py-12 lg:py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-[1600px] px-6 lg:px-16 xl:px-24 relative z-10 w-full">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-7xl xl:text-[8rem] font-fredoka font-bold text-slate-800 leading-[0.9] tracking-tight">
            ...
            {t.features.map((feature, i) => {
              ...
              return (
                <MotionItem key={feature.title} className="h-full">
                  <Link href={hrefs[i]} className="group block h-full bg-[#faf8c3] p-10 lg:p-12 rounded-[3.5rem] border border-yellow-100 shadow-sm hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 relative overflow-hidden text-center">
        ...
        <div className="mx-auto max-w-[1600px] px-6 lg:px-16 xl:px-24 relative z-10 w-full">
          <div className="bg-[#faf8c3] rounded-[4rem] p-10 lg:p-20 relative overflow-hidden shadow-2xl flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="relative w-full lg:w-3/5 space-y-10 order-2 lg:order-1 text-center lg:text-left">
              <MotionWrapper direction="right">
                <div className="space-y-8">
                  <h2 className="text-6xl lg:text-8xl xl:text-[9rem] font-fredoka font-bold text-slate-900 leading-[0.9] tracking-tight text-balance">
            ...
            <div className="relative w-full lg:w-2/5 flex justify-center lg:justify-end order-1 lg:order-2 lg:left-40">
              <MotionWrapper type="fade" className="relative w-[400px] h-[400px] lg:w-[800px] lg:h-[800px] lg:-my-32">
