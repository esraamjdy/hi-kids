           ...
           <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16 border-b border-slate-100 pb-12 mb-12">
               ...
               <div className="flex-1 text-center lg:text-left pt-8">
                  <MotionWrapper direction="right">
                    <span className="bg-green-50 text-hikids-green border-green-100 text-xs font-black uppercase tracking-[0.2em] px-6 py-2 rounded-full inline-block border backdrop-blur-sm mb-4">
                        SUPPORT
                    </span>
